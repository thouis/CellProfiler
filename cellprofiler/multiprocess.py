...
from cellprofiler.distributed import Distributor
...
def worker_looper(url):
    ...
    while has_work:
        ...
        if(jobinfo and jobinfo.is_valid):
            ...
            response = transit.report_measurements(measurements)
...
def _start_serving_headless(pipeline, port, output_file_path, status_callback):
    ...
    distributor.start_serving(pipeline, output_file_path, status_callback)
