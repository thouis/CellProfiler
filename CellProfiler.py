...
def main():
    ...
    try:
        ...
        lc.fileConfig(options.log_level)
    ...
    if (sys.platform == 'win32') and options.run_ilastik:
        # We think this code was added back-in-the-day to make ilastik work. (Ray & Lee - 2011-12-06)
        ...
        if options.show_gui:
            ...
            while continue_looping:
                ...
                try:
                    ...
                    logging.root.info("Failed to load measurements from pipeline", exc_info=True)
    ...
    os._exit(0)  # Java shutdown hang avoidance.
